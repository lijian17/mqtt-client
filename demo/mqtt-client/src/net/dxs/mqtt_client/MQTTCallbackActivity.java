...
import net.dxs.mqtt_client.mqtt.MQTTCallback;
...
public class MQTTCallbackActivity extends Activity implements OnClickListener {
	...
	private void initData() {
		mMqtt = new MQTTCallback(handler);
	}
